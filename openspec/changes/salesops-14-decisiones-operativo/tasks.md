...
- [ ] 4.1 RED: update `gestor-ranking.test.tsx` — `[7d/30d/General]` selector prop, caller pre-filters via `windowedState` (spec: Ranking de Gestores).
- [ ] 4.2 GREEN: modify `components/decisiones/gestor-ranking.tsx` to add the period selector.
